...
function html(body: string, status = 200): Response {
  return new Response(body, {
    ...
    headers: {
      ...
      // A page renders only its own inline styles and no scripts — a strict CSP is cheap defense in
      // depth over the escape-first renderer.
...
<style>
:root{--bg:#fff;--fg:#1f2328;--muted:#656d76;--border:#d0d7de;--link:#0969da;--code:#f6f8fa;--badge:#eaeef2;--ok:#1a7f37;--warn:#cf222e}
@media (prefers-color-scheme:dark){:root{--bg:#0d1117;--fg:#e6edf3;--muted:#8b949e;--border:#30363d;--link:#58a6ff;--code:#161b22;--badge:#21262d;--ok:#3fb950;--warn:#f85149}}
...
.container{max-width:860px;margin:0 auto;padding:2rem 1.25rem 5rem}
a{color:var(--link);text-decoration:none}a:hover{text-decoration:underline}
h1{font-size:1.7rem;margin:.2rem 0 .6rem}h2{font-size:1.2rem;margin:2rem 0 .6rem;border-bottom:1px solid var(--border);padding-bottom:.3rem}h3{font-size:1.05rem;margin:1.4rem 0 .4rem}
...
table.kv td:first-child{color:var(--muted);width:8rem;padding:.2rem .5rem .2rem 0;vertical-align:top}
table.versions td{padding:.35rem .5rem;border-bottom:1px solid var(--border)}
table.versions tr.here{background:var(--code)}
...
.decl{margin:1.2rem 0}.kind{color:var(--muted);font-weight:400;font-size:.85em}
pre.sig{background:var(--code)}
.prose{max-width:65ch}.prose p{margin:.5rem 0}
.module{margin:1.5rem 0 2.5rem}
...
<div class="container">
${body}
<footer><a href="/">Noeta registry</a> · an index, not a code store · docs are advisory metadata</footer>
</div>
</body>
</html>`;
}
